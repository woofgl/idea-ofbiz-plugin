 ...
 */
public class ComponentFileSetConfigurationTab extends FacetEditorTab implements Disposable {
  ...
  public void apply() {
/*    final Set<OfbizFileSet> fileSets = originalConfiguration.getComponentFileSets();
    fileSets.clear();
  ...
  public void reset() {
/*    myBuffer.clear();
    final Set<OfbizFileSet> sets = originalConfiguration.getComponentFileSets();
