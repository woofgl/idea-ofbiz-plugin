...
public class FileSetEditor extends DialogWrapper {
  ...
  private OfbizFilesTree myFilesTree;

  private final OfbizFileSet myFileSet;
  private final OfbizFileSet myOriginalSet;

  protected FileSetEditor(final Component parent,
                          final OfbizFileSet fileSet,
                          final FacetEditorContext context,
                          final OfbizConfigsSercher searcher) {

    super(parent, true);

    setTitle("File Sets ");
    myOriginalSet = fileSet;
    myFileSet = new OfbizFileSet(fileSet);
  ...
  public OfbizFileSet getEditedFileSet() {
    return myFileSet;
  }
}