 ...
 */
public class OfbizComponentConfigsSearcher implements OfbizConfigsSercher {
    ...
    public OfbizComponentConfigsSearcher(final Module module) {
        this.module = module;
    }
    ...
    public void search() {
        ...
        final List<DomFileElement<Component>> elements =
//      DomService.getInstance().getFileElements(Controller.class, module.getProject(), GlobalSearchScope.moduleWithDependenciesScope(module));
        DomService.getInstance().getFileElements(Component.class, module.getProject(), GlobalSearchScope.allScope(module.getProject()));
        for (final DomFileElement<Component> element : elements) {
