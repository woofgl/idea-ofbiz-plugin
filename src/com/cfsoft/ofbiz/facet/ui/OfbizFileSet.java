 ...
 */
public class OfbizFileSet implements Disposable {
  ...
  @NonNls
  private static final String ID_PREFIX = "ofbiz_fileset";

  private static final Function<OfbizFileSet, String> FILESET_NAME_FUNCTION = new Function<OfbizFileSet, String>() {
    public String fun(final OfbizFileSet ofbizFileSet) {
      return ofbizFileSet.getName();
    }
  };

  private static final Function<OfbizFileSet, String> FILESET_ID_FUNCTION = new Function<OfbizFileSet, String>() {
    public String fun(final OfbizFileSet ofbizFileSet) {
      return ofbizFileSet.getId();
    }
  };

  public OfbizFileSet(@NotNull @NonNls final String id,
                      @NotNull @NonNls final String name,
                      @NotNull final OfbizFacetConfiguration parent) {
    this.id = id;
    this.name = name;
  ...
  public OfbizFileSet(@NotNull final OfbizFileSet original) {
    id = original.id;
    name = original.name;
  ...
  public static String getUniqueId(final Set<OfbizFileSet> list) {
    return UniqueNameGenerator.generateUniqueName(ID_PREFIX, ContainerUtil.map2List(list, FILESET_ID_FUNCTION));
  }

  public static String getUniqueName(final String prefix, final Set<OfbizFileSet> list) {
  ...
  public boolean equals(final Object another) {
    if (another instanceof OfbizFileSet) {
      final OfbizFileSet obj = (OfbizFileSet) another;
