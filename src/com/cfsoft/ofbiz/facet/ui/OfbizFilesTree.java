 ...
 */
public class OfbizFilesTree extends CheckboxTreeBase {
  ...
  public void updateFileSet(final OfbizFileSet fileSet) {
  ...
  private static CheckedTreeNode createFileNode(final PsiFile file, final OfbizFileSet fileSet) {
