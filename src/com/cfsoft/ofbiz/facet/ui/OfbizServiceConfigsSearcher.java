 ...
 */
public class OfbizServiceConfigsSearcher implements OfbizConfigsSercher{
  ...
  public OfbizServiceConfigsSearcher(final Module module) {
    this.module = module;
  }
  ...
  public void search() {
    ...
    final List<DomFileElement<Services>> elements =
//      DomService.getInstance().getFileElements(Controller.class, module.getProject(), GlobalSearchScope.moduleWithDependenciesScope(module));
      DomService.getInstance().getFileElements(Services.class, module.getProject(), GlobalSearchScope.allScope(module.getProject()));
    for (final DomFileElement<Services> element : elements) {
