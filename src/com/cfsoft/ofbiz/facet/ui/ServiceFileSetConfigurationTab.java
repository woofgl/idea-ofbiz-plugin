 ...
 */
public class ServiceFileSetConfigurationTab extends FacetEditorTab implements Disposable {
            ...
            public void actionPerformed(final ActionEvent e) {
                final OfbizFileSet fileSet =
                        new OfbizFileSet(OfbizFileSet.getUniqueId(myBuffer),
                                OfbizFileSet.getUniqueName("My Services Fileset", myBuffer),
    ...
    public void apply() {
/*        final Set<OfbizFileSet> fileSets = originalConfiguration.getServiceFileSets();
        fileSets.clear();
    ...
    public void reset() {
/*        myBuffer.clear();
        final Set<OfbizFileSet> sets = ServiceManager.getInstance(module.getProject()).getAllConfigFileSets(module);
    ...
    private static final class ConfigFileNode extends SimpleNode {
        ...
        ConfigFileNode(final VirtualFilePointer name, final SimpleNode parent) {
            super(parent);
            myFilePointer = name;
            setIcons(OfbizIcons.SERVICE_CONFIG_FILE, OfbizIcons.SERVICE_CONFIG_FILE);
        }
